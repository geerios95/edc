...
["images/logo-NACDL.png","California Woman Lawyers",""],
["images/logo-NACDL.png","Fresno County Women Lawyers",""],
["images/logo-NACDL.png","Fresno County Bar Association",""],
["images/logo-NACDL.png","National Association of Criminal Defence Lawyers",""],
["images/logo-NACDL.png","California DUI Lawyers Association",""],
["images/logo-NACDL.png","State of California Bar Association",""] // no comma at end of last index
]

imgPlaces=3 // number of images visible
imgHeight=110 // height of the images
imgWidth=992 // width of the images
...
newImg.alt=""
newImg.i=i
newImg.onclick=function(){his3Win(data[this.i][0])}
...
currentImage.alt=data[nextPic][1]
currentImage.i=nextPic
currentImage.onclick=function(){his3Win(data[this.i][0])}
...
//window.open(loc)
newin=window.open(loc,'win1','left=0,top=0,width=100%,height=300') // use for specific size and positioned window
newin.focus()
}
}
